@echo off
REM Windows batch script for development
...
docker-compose -f docker-compose.yml -f docker-compose.override.yml --env-file .env --env-file .env.development up --build -d
